...
function Get-Link {
    ...
    switch ($mirror) {
        $true { return "https://spotifyadblocker-org.github.io/modded-spotx/" + $endlink }
        default { return "https://raw.githubusercontent.com/SpotifyAdBlocker-org/modded-spotx/main" + $endlink }
    }
}
...
function Kill-Spotify {
    ...
    for ($attempt = 1; $attempt -le $maxAttempts; $attempt++) {
        ...
        $spotifyProcesses = $allProcesses | Where-Object { $_.ProcessName -ilike "*spotify*" -and $_.ProcessName -inotlike "*spotifyAB*" }
